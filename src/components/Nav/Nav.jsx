    ...
    const Nav = () => {
        ...
        return (
            <div 
                ...
                <form 
                  className=' bg-white md:w-[70%] w-[40%] h-[60px] flex  items-center  px-5  gap-5 rounded-xl shadow-md' onSubmit={(e) => e.preventDefault()} >
                    <IoSearch 
                ...
                <div 
                   className=' w-[60px] h-[60px]  bg-white flex justify-center items-center rounded-md shadow-xl relative  ' onClick={() =>{
                    setShowCart(true)
                 }}>

                    <span 
                     className='absolute top-0 right-2 text-green-500 font-bold text-[18px]'> 0
                    </span>
                    <LuShoppingBag 
